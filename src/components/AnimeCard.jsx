    ...
    <Link to={`/anime/${anime.mal_id}`} className="anime-card">
      <div className="anime-card-image">
        ...
        <div className="anime-card-overlay">
          <button className={`overlay-btn ${isFavorite(anime.mal_id) ? 'active' : ''}`} onClick={handleFavoriteClick} title="To favorites">
          ...
          <button className={`overlay-btn ${isInWatchlist(anime.mal_id) ? 'active' : ''}`} onClick={handleWatchlistClick} title="Watched">
          ...
          <button className={`overlay-btn btn-plans ${isInPlans(anime.mal_id) ? 'active' : ''}`} onClick={handlePlansClick} title="In Plans">
